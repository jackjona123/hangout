...
### Do not bring other server drama to JJH

JJH is not the place to bring up drama that happened outside the server.
...
JJH is not a recruitment platform for programmers for your project. There are plenty of sites out there specifically designed for this purpose.
